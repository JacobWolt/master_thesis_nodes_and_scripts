...
gmx grompp -f nvt-equi-popc.mdp -c em.gro -r em.gro -p topol.top -n index.ndx -o nvt-equi.tpr -maxwarn 100
...
gmx grompp -f npt-equi-popc.mdp -c nvt-equi.gro -r nvt-equi.gro -p topol.top -n index.ndx -o npt-equi.tpr -maxwarn 100
...
### 1 ns NPT TEST RUN ###
 ...
 gmx grompp -f npt-equi2-tst-popc.mdp -c npt-equi.gro -r npt-equi.gro -p topol.top -n index.ndx -o npt-equi2-tst.tpr -maxwarn 100
...
#cp *.trr *.gro *.log *.xtc *.edr *.cpt /gpfs/home1/jwoltjer/MD_simulations/results/equi/${dir}/
